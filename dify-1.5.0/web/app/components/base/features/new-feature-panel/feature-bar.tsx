...
const FeatureBar = ({
  ...
  return (
    <div className='m-1 mt-0 -translate-y-2 rounded-b-[10px] border-b border-l border-r border-components-panel-border-subtle bg-util-colors-indigo-indigo-50 px-2.5 py-2 pt-4' style={{ display: isCurrentWorkspaceManager ? 'block' : 'none'}}>
      {noFeatureEnabled && (
