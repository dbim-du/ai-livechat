...
;
layui.define(['laylang'],function(e) {
    "use strict";
    ...
    u.prototype.type = function() {
        ...
        u.prototype.view = function() {
            ...
            a.curr > a.pages && (a.curr = a.pages),
                ...
                a.prev = "prev" in a ? a.prev: "&#x4E0A;&#x4E00;&#x9875;  AAA",
            ...
            var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t: 1)) : 1,
                i = {
                    ...
                    count: lang == 'en-us' ? '<span class="layui-laypage-count">total ' + a.count + " </span>":'<span class="layui-laypage-count">共 ' + a.count + " 条</span>",
                    limit: function() {
                        var e = ['<span class="layui-laypage-limits"><select lay-ignore>'];
                        return layui.each(a.limits,
                            function(t, n) {
                                e.push('<option value="' + n + '"' + (n === a.limit ? "selected": "") + ">" + n + " " + (lang == 'en-us'?'/page':'条/页') + "</option>")
                            }),
                        e.join("") + "</select></span>"
                    } (),
                    refresh: ['<a href="javascript:;" data-page="' + a.curr + '" class="layui-laypage-refresh">', '<i class="layui-icon layui-icon-refresh"></i>', "</a>"].join(""),
                    skip: function() {
                        return ['<span class="layui-laypage-skip">' + (lang == 'en-us'?'Page':'到第'), '<input type="text" min="1" value="' + a.curr + '" class="layui-input">', (lang == 'en-us'?'':'页') + '<button type="button" class="layui-laypage-btn">' + (lang == 'en-us'?'Skip':'确定') + '</button>', "</span>"].join("")
                    } ()
                };
