    ...
    public function add()
    {
        if(request()->isPost()) {
            ...
            if (empty($isMakeIndex)) {
                return JsonRes::failed('索引文档失败',-1);
            }
            ...
            if (1 == $isMakeIndex['create_index_flag']) {
                ...
                try {
                    ...
                    return JsonRes::failed('创建索引失败',-2,0,$e->getMessage());
                }
            ...
            try {
                ...
                return JsonRes::failed('创建索引失败',-3,0,$e->getMessage());
            }
    ...
    public function edit()
    {
        if(request()->isPost()) {
            ...
            try {
                ...
                return JsonRes::failed('编辑索引失败',-1,0,$e->getMessage());
            }
