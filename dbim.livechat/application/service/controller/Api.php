...
class Api extends Controller
{
    ...
    public function getNowServiceList()
    {
        ...
        if ($cacheToken != input('param.token')) {
            return JsonRes::failed('登录过期',403);
        }
        ...
        if(0 != $newService['code'] || empty($newService['data'])) {
            return JsonRes::success('empty list');
        }
    ...
    public function getCity()
    {
        ...
        return JsonRes::success('ok',rtrim($address, '-'));
    }
    ...
    public function reLink()
    {
        ...
        try {
            ...
            return JsonRes::failed($e->getMessage(),-1);
        }
        return JsonRes::success('online info',$groups);
    }
    ...
    public function updateCustomerInfo()
    {
        ...
        if (empty($param)) {
            return JsonRes::success('save nothing');
        }
    ...
    public function census()
    {
        ...
        return JsonRes::success('success',[
            'totalNum' => $totalNum,
            'nowNum' => $nowNum,
    ...
    public function uploadImg()
    {
        ...
        if($info){
            ...
            return JsonRes::success('success',['src' => $src ]);
        }else{
            // 上传失败获取错误信息
    ...
    public function uploadFile()
    {
        ...
        if($info){
            $src =  '/uploads' . '/' . date('Ymd') . '/' . $info->getFilename();
            return JsonRes::success('success',['src' => $src, 'name' => $fileInfo['name'] ]);
        }else{
            // 上传失败获取错误信息
            return JsonRes::failed($file->getError(),-1);
        }
